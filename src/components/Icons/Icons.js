...
export const MsgIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const PasswordunHideIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 20 20"
...
export const PasswordHideIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 20 20"
...
export const PopulationIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const PlayIcon = ({ width = '2rem', height = '2rem', className, onClick }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const PauseIcon = ({ width = '2rem', height = '2rem', className, onClick }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const SoundIcon = ({ width = '2rem', height = '2rem', className, onClick }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const SoundMuteIcon = ({ width = '2rem', height = '2rem', className, onClick }) => (
    <svg
        className={className}
        width={width}
        height={height}
